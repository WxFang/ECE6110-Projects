...
void EnqueueAtRed(Ptr<const QueueItem> item) {
	...
	if(tcp.GetDestinationPort () == 60001) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60002) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60003) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60004) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60005) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60006) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60007) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
	else if(tcp.GetDestinationPort () == 60008) std::cout << Simulator::Now() << "\t" << tcp.GetDestinationPort () << "\t" << tcp.GetSequenceNumber() << "\t" << std::endl;
